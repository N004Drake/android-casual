...
public class CASUALPackage {
    ...
    private void loadProperties(String noExtensionLink) throws IOException, NoMetaException {
        NetworkProperties dotMeta=new NetworkProperties(noExtensionLink+".meta");
        ...
        NetworkProperties dotProp=new NetworkProperties(noExtensionLink+".properties");
        developer=dotProp.getProperties().getProperty("Developer.Name","");
        donateTo=dotProp.getProperties().getProperty("Developer.DonateToButtonText","");
        donateLink=dotProp.getProperties().getProperty("Developer.DonateLink","");
        windowTitle=dotProp.getProperties().getProperty("Window.Title","");
